...
#### 5.5. À quoi sert la mise en cache des réponses ? (plusieurs réponses possibles)
...
#### 5.6. Que permet une interface uniforme ? (plusieurs réponses possibles)
...
- [x] En découvrant différents endpoints dans les retours des requêtes
