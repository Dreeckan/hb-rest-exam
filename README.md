...
- [x] Une extension de javascript, seul moyen d'utiliser AJAX

### 4. Définitions

#### 4.1. Qu'est-ce que REST ? (une seule réponse)

- [x] Un protocole (comme HTTP) de communication entre une ou des applications mobiles et un serveur tiers
